...
class RCManager{
	...
	public void findSub() {							//과목 조회 메서드
		...
		System.out.println(sub+" => "+RCM.get(sub));//get을 통한 해당 과목의 value값 호출
	}
	...
	public void updateSub() {						//과목 수정 메서드
		...
		RCM.put(sub, point);						//put을 통한 해당 과목의 value값 수정
	}
	...
	public void deleteSub() {						//과목 삭제 메서드
		...
		RCM.remove(sub);							//remove를 통한 해당 key값 삭제
