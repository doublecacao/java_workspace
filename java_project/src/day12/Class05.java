...
public class Class05 {
	...
	public static void main(String[] args) {
		 ...
		 * static이 안붙은 멤버변수/메서드 들은 객체(인스턴스) 멤버변수/메서드라고 한다.
		 * 
		 ...
		 * -모든 객체들이(하나의 클래스를 통해 생성되는 모든 객체) 동일한 값을 사용한다면 static 붙이는 것을 고려 
		 * 
		 ...
		 * -객체 멤버 변수는 클래스 멤버 메서드에서 사용할 수 없다. (객체를 생성해야 사용가능)
		 * -객체 멤버 메서드도 멤버 메서드에서 사용할 수 없다. (객체를 생성해야 사용가능)
		 */
		TV t = new TV();
		t.isPower();
